...
class AliPay:
    ...
    def notify_verify(self, request):
        ...
        params['is_success'] = request.get('is_success', '')
        params['partnerId'] = request.get('partnerId', '')
        ...
        params['seller_email'] = request.get('seller_email', '')
        params['seller_id'] = request.get('seller_id', '')
        params['buyer_email'] = request.get('buyer_email', '')
        params['buyer_id'] = request.get('buyer_id', '')
        params['discount'] = request.get('discount', '')
        params['total_fee'] = request.get('total_fee', '')
        params['trade_status'] = request.get('trade_status', '')
        params['is_total_fee_adjust'] = request.get('is_total_fee_adjust', '')
        params['use_coupon'] = request.get('use_coupon', '')
        params['body'] = request.get('body', '')
        params['exterface'] = request.get('exterface', '')
        params['out_trade_no'] = request.get('out_trade_no', '')
        params['payment_type'] = request.get('payment_type', '')
        params['logistics_type'] = request.get('logistics_type', '')
        params['logistics_fee'] = request.get('logistics_fee', '')
        params['logistics_payment'] = request.get('logistics_payment', '')
        params['gmt_logistics_modify'] = request.get('gmt_logistics_modify', '')
        params['buyer_actions'] = request.get('buyer_actions', '')
        params['seller_actions'] = request.get('seller_actions', '')
        params['gmt_create'] = request.get('gmt_create', '')
        params['gmt_payment'] = request.get('gmt_payment', '')
        params['refund_status'] = request.get('refund_status', '')
        params['gmt_refund'] = request.get('gmt_refund', '')
        params['receive_name'] = request.get('receive_name', '')
        params['receive_address'] = request.get('receive_address', '')
        params['receive_zip'] = request.get('receive_zip', '')
